...
DATA(insert (	405		jsonb_ops			PGNSP PGUID 4034  3802 f 0 ));
DATA(insert (	783		jsonb_ops			PGNSP PGUID 4035  3802 f 3801 ));
DATA(insert (	2742	jsonb_ops			PGNSP PGUID 4036  3802 f 25 ));
